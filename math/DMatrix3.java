/*************************************************************************
 * * Open Dynamics Engine 4J, Copyright (C) 2009-2014 Tilmann Zaeschke * All
 * rights reserved. Email: ode4j@gmx.de Web: www.ode4j.org * * This library is
 ...
 * License is included with this library in the * file LICENSE.TXT. * (2) The
 * BSD-style license that is included with this library in * the file
 * ODE4J-LICENSE-BSD.TXT. * * This library is distributed in the hope that it
 * will be useful, * but WITHOUT ANY WARRANTY; without even the implied warranty
 * of * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the files *
...
public final class DMatrix3 implements DMatrix3C
{
    ...
    /**
     * Initialises this matrix from a 3*4 double [] with 12 fields, ignoring the
     ...
     * the digit refers to the argument that is transposed: 0: A = B * C (sizes:
     * A:p*r B:p*q C:q*r) 1: A = B' * C (sizes: A:p*r B:q*p C:q*r) 2: A = B * C'
    ...
    /**
     * View a particular column as dVector3. For example: <br>
     * <tt>
     * //  dir[0] = R[0*4+2];  <br>
     * //  dir[1] = R[1*4+2];  <br>
     * //  dir[2] = R[2*4+2];  <br>
    ...
    /**
     * Compares two matrices for equality. This is marginally faster than
     * <tt>equals(Object o)</tt>.
     */
    @Override
    ...
    /**
     * Do not use. This can be slow, use isEquals() instead. Compares two
     * objects for equality. This is marginally slower than
     * <tt>isEquals(DMatrix3C m)</tt>.
     */
    @Override
    @Deprecated
    ...
    /**
     * Make the matrix an identity matrix. Same as setIdenity().
     */
    ...
    /**
     * Make the matrix an identity matrix. Same as eqIdenity().
     */
    ...
    /**
     * Set the matrix to zero. Same as setZero().
     */
    ...
    /**
     * Set the matrix to zero. Same as eqZero().
     */
    ...
    {
        return new float[] { (float)get00(), (float)get01(), (float)get02(), 0.0f, (float)get10(),
            (float)get11(), (float)get12(), 0.0f, (float)get20(), (float)get21(), (float)get22(),
            0.0f };
    }
    ...
    {
        return new float[] { (float)get00(), (float)get01(), (float)get02(), (float)get10(),
            (float)get11(), (float)get12(), (float)get20(), (float)get21(), (float)get22() };
    }
    ...
    /**
     * Calculates the dot product of the the specified row of this matrix with
     * the given vector.
     * 
     * @param row
     * @param v3
    ...
    /**
     * Calculates the dot product of the the specified column <tt>col</tt> of
     * this matrix with the specified column <tt>col2</tt> of the second matrix
     * <tt>m2</tt>.
     * 
     * @param col
     * @param m2
    ...
    /**
     * Calculates the dot product of the the specified row <tt>row</tt> of this
     * matrix with the specified column <tt>col2</tt> of the second matrix
     * <tt>m2</tt>.
     * 
     * @param row
     * @param m2
    ...
    /**
     * Calculates the dot product of the the specified row of this matrix with
     * the given array at the given offset.
     * 
     * @param row
     *            The row.
     * @param c
    ...
    /**
     * Calculates the dot product of the the specified row <tt>row</tt> of this
     * matrix with the specified row <tt>row2</tt> of the second matrix
     * <tt>m2</tt>.
     * 
     * @param row
     * @param m2
